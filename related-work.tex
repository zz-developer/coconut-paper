...
However, they still face problems with scaling up and stability.
...
It excels in feasibility and stability, which places in the approach to train the model without specifically-designed trajectories, e.g., stepping guidance.
It also combines the advances of explicit reasoning models and large-scale reinforcement learning objectives, while prior work mainly focused on how to produce the latent reasoning space.
